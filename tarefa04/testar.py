...
class Task(BaseTask):
    def teste_1_alimentos(self):
        script = "alimentos.py"
        self.test_cases(script, self.case_range("alimentos{}.in", 1, 15))
    
    def teste_2_variar_alimentos(self):
        script = "variar_alimentos.py"
        self.test_cases(script, self.case_range("variar_alimentos{}.in", 1, 12))

    def teste_3_variar_alimentos_corner_case(self):
        script = "variar_alimentos.py"
        self.test_cases(script, self.case_range("variar_alimentos{}.in", 13, 18))
