...
class Task(BaseTask):
    def compare_output(self, out, res):
        return self.compare_doubles(out, res)

    def teste_01_fatorial(self):
        tests = [
            ("0", "1"),
            ("1", "1"),
            ("5", "120"),
    ...
    def teste_04_busca_binaria(self):
        script = "busca_binaria.py"
        self.test_cases(script, self.case_range("busca_binaria{}.in", 1, 8))

    def teste_05_saltare(self):
        tests = [
            ("1", "1"),
            ("2", "1"),
            ("3", "1"),
            ...
            ("227", "20135262523281072554522838620821641409"),
        ]
        script = "saltare.py"
        for (inputvalue, outputvalue) in tests:
            self.input_output(script, inputvalue, outputvalue)

    def teste_06_recompensa(self):
        tests = [
            ("2 1", "0.167"),
            ("2 2", "0.194"),
            ("3 9", "0.227"),
    ...
    def teste_07_intercalar(self):
        script = "intercalar.py"
        self.test_cases(script, self.case_range("intercalar{}.in", 1, 6))

    def teste_08_caminhos(self):
        script = "caminhos.py"
        self.test_cases(script, self.case_range("caminhos{}.in", 1, 6))

    def teste_09_produtos(self):
        script = "produtos.py"
        self.test_cases(script, self.case_range("produtos{}.in", 1, 8))

    def teste_10_lagos(self):
        script = "lagos.py"
        self.test_cases(script, self.case_range("lagos{}.in", 1, 6))
