...
class Task(BaseTask):
    def teste_1_fluxograma(self):
        assert(
            isfile("collatz.png") or isfile("collatz.jpg")
        ), "deve haver uma imagem collatz.png ou collatz.jpg"

    def teste_2_pseudocodigo(self):
        arquivo = "collatz.md"
        n_words = 30
    ...
    def teste_3_programas(self):
        arquivo = "programas.md"
        n_words = 60
