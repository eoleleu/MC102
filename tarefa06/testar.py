...
class Task(BaseTask):
    ...
    def teste_1_tendencia_ordenada(self):
        script = "tendencia.py"
        self.test_cases(script, self.case_range("tendencia{}.in", 1, 8))

    def teste_2_tendencia_desordenada(self):
        script = "tendencia.py"
        self.test_cases(script, self.case_range("tendencia{}.in", 9, 12))

    def teste_3_discrepancias(self):
        script = "discrepancias.py"
        self.test_cases(script, self.case_range("discrepancias{}.in", 1, 12))
