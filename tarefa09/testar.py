...
class Task(BaseTask):
    ...
    def teste_1_criticos_pequeno(self):
        script = "harmonicos_criticos.py"
        self.test_cases(script, self.case_range("criticos{}.in", 1, 2))

    def teste_2_criticos_medio(self):
        script = "harmonicos_criticos.py"
        self.test_cases(script, self.case_range("criticos{}.in", 3, 3))

    def teste_3_criticos_grande(self):
        script = "harmonicos_criticos.py"
        self.test_cases(script, self.case_range("criticos{}.in", 4, 4))

    def teste_4_amenizar_pequeno(self):
        script = "amenizar_impactos.py"
        self.test_cases(script, self.case_range("amenizar{}.in", 1, 2))

    def teste_5_amenizar_medio(self):
        script = "amenizar_impactos.py"
        self.test_cases(script, self.case_range("amenizar{}.in", 3, 3))

    def teste_6_amenizar_grande(self):
        script = "amenizar_impactos.py"
        self.test_cases(script, self.case_range("amenizar{}.in", 4, 5))
