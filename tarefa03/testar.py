...
class Task(BaseTask):
    def teste_1_recepcionista(self):
        script = "recepcionista.py"
        self.test_cases(script, self.case_range("recepcionista{}.in", 1, 11))

    def teste_2_enfermeira_simples(self):
        script = "enfermeira.py"
        self.test_cases(script, self.case_range("enfermeira{}.in", 1, 2))

    def teste_3_enfermeira(self):
        script = "enfermeira.py"
        self.test_cases(script, self.case_range("enfermeira{}.in", 3, 6))
