...
class Task(BaseTask):
    def teste_1_criar(self):
        script = "gerenciador.py"
        self.test_cases(script, self.case_range("cria{}.in", 1, 1))

    def teste_2_listar(self):
        script = "gerenciador.py"
        self.test_cases(script, self.case_range("lista{}.in", 1, 1))

    def teste_3_carregar(self):
        script = "gerenciador.py"
        self.test_cases(script, self.case_range("carrega{}.in", 1, 2))

    def teste_4_comparar(self):
        script = "gerenciador.py"
        self.test_cases(script, self.case_range("compara{}.in", 1, 3))

    def teste_5_substituir(self):
        script = "gerenciador.py"
        self.test_cases(script, self.case_range("sub{}.in", 1, 3))
        self.test_cases(script, self.case_range("cria{}.in", 3, 3))

    def teste_6_buscar(self):
        script = "gerenciador.py"
        self.test_cases(script, self.case_range("busca{}.in", 1, 3))
        self.test_cases(script, self.case_range("cria{}.in", 2, 2))
